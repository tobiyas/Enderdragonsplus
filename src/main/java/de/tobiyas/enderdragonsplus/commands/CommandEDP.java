...
public class CommandEDP implements CommandExecutor {
	...
	public boolean onCommand(CommandSender sender, Command command, String label,
		...
		if(page == 1){
			...
			if(plugin.getPermissionManager().checkPermissionsSilent(sender, PermissionNode.removeRespawner)){
		...
		if(!usedAny){
			sender.sendMessage(ChatColor.RED + "You have no Permissions to use any Command.");
		}
