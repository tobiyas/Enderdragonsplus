package de.tobiyas.enderdragonsplus.entity.fireball.v1_7_R4;
...
public class LimitedFireball_1_7R4 extends EntityLargeFireball implements LimitedFireball {

	private double speedup = 1;
	private int maxSurvivalCounter = 20 * 5; // 20 ticks per sec * 5 seconds

	public LimitedFireball_1_7R4(World world) {
		super(world);
	}
