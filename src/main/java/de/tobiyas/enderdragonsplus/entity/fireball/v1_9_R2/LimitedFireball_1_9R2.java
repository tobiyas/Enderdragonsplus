package de.tobiyas.enderdragonsplus.entity.fireball.v1_9_R2;
...
public class LimitedFireball_1_9R2 extends EntityLargeFireball implements LimitedFireball {

	private double speedup = 1;
	private int maxSurvivalCounter = 20 * 5; // 20 ticks per sec * 5 seconds

	public LimitedFireball_1_9R2(World world) {
		super(world);
	}

	public LimitedFireball_1_9R2(World world, EntityLiving entityliving, double d0,
			double d1, double d2) {
		super(world, entityliving, d0, d1, d2);
	}
	
	public LimitedFireball_1_9R2(org.bukkit.World world, org.bukkit.entity.LivingEntity entityliving, double d0,
			double d1, double d2) {
