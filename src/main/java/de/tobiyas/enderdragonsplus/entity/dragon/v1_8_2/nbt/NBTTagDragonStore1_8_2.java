package de.tobiyas.enderdragonsplus.entity.dragon.v1_8_2.nbt;
...
import de.tobiyas.enderdragonsplus.entity.dragon.v1_8_2.LimitedEnderDragon;

public class NBTTagDragonStore1_8_2 {
	...
	public void saveToNBT(LimitedEnderDragon dragon, NBTTagCompound compoundToSaveTo, Map<String,Object> propertiesCompound, 
		...
		compoundToSaveTo.set("age", AgeContainerBuilder1_8_2.saveToNBTTagCompound(dragon.getAgeContainer()));
	...
	public DragonNBTReturn loadFromNBT(LimitedED dragon, NBTTagCompound compound){
		...
		returnValue.setHomeLocation(homeLocation)
					...
					.setAgeContainer(AgeContainerBuilder1_8_2.buildFromNBTTag(compound.getCompound("age")))
