...
import de.tobiyas.enderdragonsplus.entity.dragon.v1_7_3.LimitedEnderDragon;

public class NBTTagDragonStore1_7_3 {
	...
	public void saveToNBT(LimitedEnderDragon dragon, NBTTagCompound compoundToSaveTo, Map<String,Object> propertiesCompound, 
		...
		compoundToSaveTo.set("age", AgeContainerBuilder1_7_3.saveToNBTTagCompound1_7_3(dragon.getAgeContainer()));
	...
	public DragonNBTReturn loadFromNBT(LimitedED dragon, NBTTagCompound compound){
		...
		returnValue.setHomeLocation(homeLocation)
					...
					.setAgeContainer(AgeContainerBuilder1_7_3.buildFromNBTTag(compound.getCompound("age")))
