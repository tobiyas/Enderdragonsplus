package de.tobiyas.enderdragonsplus.entity.dragon.v1_8_1.nbt;
...
public class NBTTagDragonStore1_8_1 {
	...
	public DragonNBTReturn loadFromNBT(LimitedED dragon, NBTTagCompound compound){
		...
		returnValue.setHomeLocation(homeLocation)
					...
					.setAgeContainer(AgeContainerBuilder1_8_1.buildFromNBTTag(compound.getCompound("age")))
