package de.tobiyas.enderdragonsplus.entity.dragon.v1_7_1;
...
import de.tobiyas.enderdragonsplus.entity.dragon.v1_7_1.nbt.NBTTagDragonStore1_7_1;
...
public class LimitedEnderDragon extends EntityEnderDragon implements LimitedED {
	...
	public void loadAdditionalNBTStuffAndCreateControllers(Object compound){
		NBTTagDragonStore1_7_1 store = new NBTTagDragonStore1_7_1();
	...
	public float getPassengerSideMot() {
		...
		return ((EntityLiving)passenger).bf;
	}
	...
	public void setPassengerSideMot(float newValue) {
		...
		((EntityLiving)passenger).bf = newValue;
	}
	...
	public boolean damage(DamageCause cause, double value) {
		if(this.dragonHealthController.isInvincible()) return false;
