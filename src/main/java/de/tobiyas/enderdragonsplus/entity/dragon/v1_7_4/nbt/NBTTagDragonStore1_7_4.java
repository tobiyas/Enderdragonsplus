...
import de.tobiyas.enderdragonsplus.entity.dragon.v1_7_4.LimitedEnderDragon;

public class NBTTagDragonStore1_7_4 {
	...
	public void saveToNBT(LimitedEnderDragon dragon, NBTTagCompound compoundToSaveTo, Map<String,Object> propertiesCompound, 
		...
		compoundToSaveTo.set("age", AgeContainerBuilder1_7_4.saveToNBTTagCompound1_7_3(dragon.getAgeContainer()));
	...
	public DragonNBTReturn loadFromNBT(LimitedED dragon, NBTTagCompound compound){
		...
		returnValue.setHomeLocation(homeLocation)
					...
					.setAgeContainer(AgeContainerBuilder1_7_4.buildFromNBTTag(compound.getCompound("age")))
