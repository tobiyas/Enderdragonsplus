package de.tobiyas.enderdragonsplus.entity.dragon.v1_8_1;
...
import de.tobiyas.enderdragonsplus.entity.dragon.v1_8_1.nbt.NBTTagDragonStore1_8_1;
...
public class LimitedEnderDragon extends EntityEnderDragon implements LimitedED {
	...
	public void loadAdditionalNBTStuffAndCreateControllers(Object compound){
		NBTTagDragonStore1_8_1 store = new NBTTagDragonStore1_8_1();
	...
	public float getPassengerSideMot() {
		...
		return ((EntityLiving)passenger).aY;
	}

	@Override
	public float getPassengerForMot() {
		if(passenger == null) return 0;
		return ((EntityLiving)passenger).aX;
	}

	@Override
	public void setPassengerSideMot(float newValue) {
		if(passenger == null) return;
		((EntityLiving)passenger).aY = newValue;
	}

	@Override
	public void setPassengerForMot(float newValue) {
		if(passenger == null) return;
		((EntityLiving)passenger).aX = newValue;
	}
